            ...
            <div class="table-responsive">
                <table class="table table-hover">
                    <thead>
                        ...
                        $otherDetails =  get_post_meta($resourceImgVal->ID);
                        ...
                        <tr class="bg-color">
                            ...
                            <td><?php echo get_post_field('post_name', $otherDetails->$ugroup_id);?></td>
                            <td>
                                ...
                                <div class="row">
                                        ...
                                        <div class="mb-3">
                                            <div class="drag-drop-images text-center image-upload-box"> 
                                                <div class="avatar-edit">
                                                    <input type="file" id="fileUpload" name="resource_media_img" accept=".png, .jpg, .jpeg">
                                    ...
                                    <div class="col-lg-12 col-12">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="title" name="title"  placeholder="Enter hereaa" id="title" name="title" >
                                    ...
                                    <div class="col-lg-12 col-12">
                                        <div class="mb-3">
                                          ...
                                          <select class="js-example-basic-multiple js-states form-control" multiple="multiple"  id="tags" name="tags[]">
                                                <?php 
                                    ...
                                    <div class="col-lg-12 col-12">
                                        <div class="form-floating mb-3">
                                            <textarea class="form-control" placeholder="Enter here" id="mr_description" name="mr_description"  style="height: 100px"></textarea>
                                                ...
                                                <div class="col-12 col-lg-12 mb-3">
                                                    <div class="form-check d-flex align-items-center">
                                                        <label class="form-check-label">
                                                            <input onclick="show32();" type="radio" <?php echo (get_post_meta($rf_id,'rf_publish',true)=="Select From My Group")?"CHECKED='CHECKED'":""?> class="form-check-input" name="rf_publish">Select From My Joined Group
                                                        </label>
                                                    </div>
                                                    <div class="form-check d-flex align-items-center">
                        ...
                        <div class="col-md-12">
                            <form method="POST" action=""  class="form-upload  resources-modal-page float mediadoc_form" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-12">
                                        <div class="mb-3">
                                            <select class="js-example-placeholder-multiple js-states form-control" multiple="multiple"   id="tags1" name="tags[]">
