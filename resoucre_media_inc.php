            ...
            <div class="table-responsive">
                <table class="table table-hover">
                    <thead>
                     ...
                     /* $otherDetail = get_post($resourceImgVal->ID);
                      print_r($otherDetail);
*/
                            ...
                            <td>
                                ...
                                <?php if(!empty($otherDetails)){?>
                                  ...
                                  <?php } else { ?> 
                                     ...
                                     <?php echo  get_post_meta($resourceImgVal->ID,'rf_publish',true); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-12">
                                        <div class="mb-3">
                                          ...
                                          <select class="js-example-basic-multiple js-states form-control" multiple="multiple"  id="tags" name="tags[]" required>
                                                <?php 
